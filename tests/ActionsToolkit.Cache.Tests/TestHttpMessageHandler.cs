...
/// <summary>
/// Minimal in-memory <see cref="HttpMessageHandler"/> used to capture
/// outgoing requests and return scripted responses, mirroring the
/// <c>TestHttpMessageHandler</c> in <c>ActionsToolkit.HttpClient.Tests</c>.
/// </summary>
