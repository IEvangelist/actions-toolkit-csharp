...
namespace ActionsToolkit.Octokit.AotConsumer;

/// <summary>
/// Native AOT dispatcher that exercises the public surface of
/// <see cref="ActionsToolkit.Octokit"/>. Mirrors concerns from the upstream
...
internal static class Program
{
    private static int Main(string[] args)
    {
        if (args.Length == 0)
        {
            return Fail("Usage: actions-toolkit-octokit-aot-consumer <case>");
        }
