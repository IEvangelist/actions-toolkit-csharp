...
namespace ActionsToolkit.Artifact.AotConsumer;

/// <summary>
/// Native AOT dispatcher that exercises the public surface of
/// <c>ActionsToolkit.Artifact</c>. Mirrors the upload, list, get,
...
internal static class Program
{
    private static int Main(string[] args)
    {
        if (args.Length == 0)
        {
            return Fail("Usage: actions-toolkit-artifact-aot-consumer <case>");
        }
