# `ActionsToolkit.Octokit` — file-based examples
...
[`ActionsToolkit.Octokit`](https://www.nuget.org/packages/ActionsToolkit.Octokit).
...
The `#:package ActionsToolkit.Octokit@*` directive at the top of
