# `ActionsToolkitSharp.IO` — file-based examples
...
[`ActionsToolkitSharp.IO`](https://www.nuget.org/packages/ActionsToolkitSharp.IO).

Each script mirrors a section of the upstream
[`@actions/io` README](https://github.com/actions/toolkit/tree/main/packages/io).
The `#:package ActionsToolkitSharp.IO@*` directive at the top of each
