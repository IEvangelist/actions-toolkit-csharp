# `ActionsToolkitSharp.ToolCache` — file-based examples
...
[`ActionsToolkitSharp.ToolCache`](https://www.nuget.org/packages/ActionsToolkitSharp.ToolCache).
...
The `#:package ActionsToolkitSharp.ToolCache@*` directive at the top of each
