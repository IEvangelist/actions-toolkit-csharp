# `ActionsToolkitSharp.HttpClient` — file-based examples
...
[`ActionsToolkitSharp.HttpClient`](https://www.nuget.org/packages/ActionsToolkitSharp.HttpClient).
...
The `#:package ActionsToolkitSharp.HttpClient@*` directive at the top of
