# `ActionsToolkitSharp.Glob` — file-based examples
...
[`ActionsToolkitSharp.Glob`](https://www.nuget.org/packages/ActionsToolkitSharp.Glob).
...
APIs. The `#:package ActionsToolkitSharp.Glob@*` directive at the top of
