# `ActionsToolkit.Exec` — file-based examples
...
[`ActionsToolkit.Exec`](https://www.nuget.org/packages/ActionsToolkit.Exec).
...
The `#:package ActionsToolkit.Exec@*` directive at the top of each
