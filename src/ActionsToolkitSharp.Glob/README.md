# `ActionsToolkitSharp.Glob` package

To install the [`ActionsToolkitSharp.Glob`](https://www.nuget.org/packages/ActionsToolkitSharp.Glob) NuGet package:

```xml
<PackageReference Include="ActionsToolkitSharp.Glob" Version="[Version]" />
```
...
using ActionsToolkitSharp.Glob.Extensions;
...
```csharp
using Microsoft.Extensions.DependencyInjection;
using ActionsToolkitSharp.Core;
