...
```xml
<PackageReference Include="ActionsToolkitSharp.Artifact" Version="[Version]" />
```
...
using ActionsToolkitSharp.Artifact.Extensions;
...
| Name                                       | Purpose                                                              |
|--------------------------------------------|----------------------------------------------------------------------|
| `ActionsToolkitSharp.Artifact`             | Twirp transport (bearer auth from `ACTIONS_RUNTIME_TOKEN`).          |
| `ActionsToolkitSharp.Artifact.PublicApi`   | REST API at `https://api.github.com/`, no auto-redirect.             |
| `ActionsToolkitSharp.Artifact.Blob`        | Bare client for blob upload/download via signed URLs (no auth).      |
