...
/// <c>ActionsToolkit.Artifact</c> services.
/// </summary>
public static class ServiceCollectionExtensions
{
    ...
    /// <see cref="ActionsToolkit"/>.<see cref="Artifact"/> services.
    ...
    public static IServiceCollection AddGitHubActionsArtifact(this IServiceCollection services)
    {
        ...
        services.AddHttpClient(DefaultArtifactClient.BlobHttpClientName, static client =>
        {
            client.DefaultRequestHeaders.UserAgent.Add(
                new ProductInfoHeaderValue("ActionsToolkit.Artifact", productVersion: null));
        });
