# `ActionsToolkit.Core` package

To install the [`ActionsToolkit.Core`](https://www.nuget.org/packages/ActionsToolkit.Core) NuGet package:

```xml
<PackageReference Include="ActionsToolkit.Core" Version="[Version]" />
```
